...
namespace DogsBarberShop.Persistence.Migrations
{
    ...
    [Migration("20211023085949_Order-Pet.Optional")]
    partial class OrderPetOptional
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DogsBarberShop.Entities.DomainModels.Order", b =>
                {
                    ...
                    b.HasIndex("PetId", "UserId")
                        .IsUnique()
                        .HasFilter("[PetId] IS NOT NULL AND [UserId] IS NOT NULL");
            ...
            modelBuilder.Entity("DogsBarberShop.Entities.DomainModels.User", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DogsBarberShop.Entities.DomainModels.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
